...
$myform->addRadio('sex','required');
$myform->addRadioOption('sex','male','Male',true);
...
for($i=1;$i<=31;$i++) {$myform->addSelectOption('day',$i,$i,($today_day==$i));}
